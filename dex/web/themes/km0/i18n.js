(function () {
  ...
  var strings = {
    es: {
      ...
      loginSubtitle: 'Elige cómo quieres iniciar sesión en cloud.km0.amvara.de',
    ...
    ca: {
      ...
      loginSubtitle: 'Tria com vols iniciar sessió a cloud.km0.amvara.de',
    ...
    en: {
      ...
      loginSubtitle: 'Choose how you want to sign in to cloud.km0.amvara.de',
    ...
    de: {
      ...
      loginEyebrow: 'Kilometer 0 Digital',
      loginSubtitle:
        'Wählen Sie, wie Sie sich bei cloud.km0.amvara.de anmelden möchten',
